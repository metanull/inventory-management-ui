...
vi.mock('@/api/client', () => ({
  apiClient: {
    ...
    createContext: vi.fn(() => Promise.resolve({ data: { id: '3', name: 'Cultural Context', description: 'Cultural significance' } })),
    updateContext: vi.fn(() => Promise.resolve({ data: { id: '1', name: 'Archaeological Research Context', description: 'Updated description' } }))
  }
}))
