...
vi.mock('@/api/client', () => ({
  apiClient: {
    getImageUploads: vi.fn(() => Promise.resolve({
      data: [
        {
          id: '1',
    ...
    createImageUpload: vi.fn(() => Promise.resolve({ data: { id: '3', filename: 'new-image.jpg' } })),
    updateImageUpload: vi.fn(() => Promise.resolve({ data: { id: '1', filename: 'updated-image.jpg' } }))
  }
}))
