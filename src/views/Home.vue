  ...
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6">
        ...
        <p class="text-gray-600 mb-4">Manage system languages and localization settings</p>
        <router-link
          to="/languages"
      ...
      <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6">
        <div class="flex items-center mb-4">
          ...
          <h2 class="text-xl font-semibold text-gray-900">Countries</h2>
        </div>
        <p class="text-gray-600 mb-4">Manage countries and geographic regions</p>
        <router-link
          to="/countries"
      ...
      <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6">
        <div class="flex items-center mb-4">
          ...
          <h2 class="text-xl font-semibold text-gray-900">Contexts</h2>
        </div>
        <p class="text-gray-600 mb-4">Manage system contexts and operational environments</p>
        <router-link
          to="/contexts"
      ...
      <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6">
        ...
        <p class="text-gray-600 mb-4">Manage projects, collections with launch dates and status</p>
        <router-link
          to="/projects"
      ...
      <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <p class="text-gray-600 mb-4">
          You are successfully authenticated and connected to the system.
        </p>
        <div
      ...
      <div class="bg-gray-50 rounded-lg shadow-md p-6">
        <div class="flex items-center mb-4">
          ...
          <h2 class="text-xl font-semibold text-gray-500">Additional Features</h2>
        </div>
        <p class="text-gray-500 mb-4">
          More inventory management features like items, addresses, and details will be implemented
          in future iterations.
        </p>
        <div
          class="inline-flex items-center px-3 py-1 bg-gray-200 text-gray-600 text-sm font-medium rounded-full"
        >
          Coming Soon
        </div>
      </div>
...
<script setup lang="ts">
  // Empty for now - will be populated with features later
</script>
